...
# IFN-γ removed from both lists — it appears in RNAseq Adaptive_Immunity domain
# and double-counting inflates cross-domain correlation artificially.
# =============================================================================

MARKERS = {
    'immune_regulation': [
        'il_2_concentration_picogram_per_milliliter',    # T-cell proliferation — primary
        'il_4_concentration_picogram_per_milliliter',    # Th2, B-cell activation
        'il_10_concentration_picogram_per_milliliter',   # anti-inflammatory regulatory brake — primary
        'il_13_concentration_picogram_per_milliliter',   # Th2 effector
        'il_15_concentration_picogram_per_milliliter',   # NK/T-cell homeostasis — primary
        'il_17a_concentration_picogram_per_milliliter',  # Th17 axis
        'il_1ra_concentration_picogram_per_milliliter',  # IL-1 antagonist, regulatory brake — primary
        ...
        'ifny_concentration_picogram_per_milliliter',    # Th1 master regulator — primary
    ],
    'inflammation': [
        'il_1a_concentration_picogram_per_milliliter',   # acute phase inflammatory
        'il_1b_concentration_picogram_per_milliliter',   # canonical inflammasome cytokine — primary
        'il_6_concentration_picogram_per_milliliter',    # master acute phase cytokine — primary
        'il_8_concentration_picogram_per_milliliter',    # neutrophil chemoattractant — primary
        ...
        'tnfa_concentration_picogram_per_milliliter',    # master pro-inflammatory cytokine — primary
        'tnfb_concentration_picogram_per_milliliter',    # pro-inflammatory (Lymphotoxin-α)
        'groa_concentration_picogram_per_milliliter',    # neutrophil chemoattractant (CXCL1)
        'mcp_1_concentration_picogram_per_milliliter',   # monocyte recruitment — primary
        ...
        'ip_10_concentration_picogram_per_milliliter',   # CXCL10, IFN-driven inflammation — primary
    ],
}

# =============================================================================
# MARKER WEIGHTS
# 1.0 = primary driver (well-established central role in domain)
